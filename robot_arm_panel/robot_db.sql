...
--
-- Host: 127.0.0.1
-- Generation Time: Aug 02, 2025 at 12:03 AM
...
CREATE TABLE `pose` (
  ...
  `servo5` int(11) DEFAULT NULL,
  `servo6` int(11) DEFAULT NULL
...
(1, 90, 90, 90, 59, 115, 34),
(2, 137, 55, 90, 26, 90, 90),
(3, 90, 115, 90, 59, 90, 33);
...
INSERT INTO `run` (`id`, `servo1`, `servo2`, `servo3`, `servo4`, `servo5`, `servo6`, `status`) VALUES
(1, 90, 115, 90, 59, 90, 33, 0);
